...
var hPos = d3.scale.linear().domain([-35,35]).range([0, svgWidth]).clamp(true);
var vPos = d3.scale.linear().domain([0, 45]).range([0, svgHeight]).clamp(true);

var active, activeX = svgWidth/2, activeY = svgHeight/2;
